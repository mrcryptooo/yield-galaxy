...
export const FALLBACK_PLANET_DATA: Record<string, PlanetInfo> = {
  USX: {
    ...
    protocols: [
      ...
      { id: 'usx-orca', name: 'Orca', apy: 0.73, tvl: '$13.8M', risk: 'B', type: 'Liquidity', depositApy: 0.73, borrowApy: 0, updated: '2m ago' },
    ],
  },
  eUSX: {
    name: 'eUSX',
...
export const CAPTAIN_PROTOCOL_LINES: Record<string, string> = {
  ...
  'usx-orca': 'USX-USDC on Orca — deep liquidity, steady returns.',
  'eusx-kamino': 'eUSX vault on Kamino — delta-neutral, low maintenance.',
  'eusx-orca': 'eUSX-USX pool — tight spread, minimal impermanent loss.',
