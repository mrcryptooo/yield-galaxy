...
// In-memory cache for live fallback (avoids re-fetching 16K pools on every request)
...
export async function GET(req: NextRequest) {
  ...
  // Fallback: fetch live from DefiLlama if Supabase is empty or fails
  ...
  // Apply client-side filters (when using live fallback, Supabase filters don't apply)
